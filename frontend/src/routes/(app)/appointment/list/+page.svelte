...
<svelte:head>
  <title>Mine avtaler</title> <!-- <h1 class="text-3xl mb-4">My appointments</h1>-->
</svelte:head>
...
<div class="mb-8">
  ...
  <p class="mt-2 max-w-2xl text-base text-slate-500">
    Her ser du kommende og tidligere avtaler. Hold oversikten og planlegg neste donasjon.
  </p>
</div>
...
{:else if data.upcoming.length === 0 && data.previous.length === 0}
  <div class="rounded-[32px] bg-white p-8 shadow-[0_16px_50px_rgba(15,23,42,0.06)] ring-1 ring-black/5">
      ...
      <section class="rounded-[32px] bg-white p-6 shadow-[0_16px_50px_rgba(15,23,42,0.06)] ring-1 ring-black/5 md:p-8">
        <div class="mb-6 flex items-center justify-between gap-4">
          ...
          <span class="rounded-full bg-red-50 px-3 py-1 text-sm font-medium text-red-600">
            {data.upcoming.length} {data.upcoming.length === 1 ? "avtale" : "avtaler"}
          </span>
        </div>
              ...
              >
                <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  ...
                  <div class="md:text-right">
                    ...
                    <span class="mt-3 inline-flex rounded-full bg-red-50 px-3 py-1 text-sm font-medium text-red-600">
                      Kommende
                    </span>
                  </div>
                </div>
      ...
      <section class="rounded-[32px] bg-white p-6 shadow-[0_16px_50px_rgba(15,23,42,0.06)] ring-1 ring-black/5 md:p-8">
        <div class="mb-6 flex items-center justify-between gap-4">
          ...
          <span class="rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-600">
            {data.previous.length} {data.previous.length === 1 ? "avtale" : "avtaler"}
          </span>
        </div>
              ...
              >
                <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  ...
                  <div class="md:text-right">
                    ...
                    <span class="mt-3 inline-flex rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-600">
                      Fullført
                    </span>
                  </div>
                </div>
